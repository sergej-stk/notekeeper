...
/**
 * @generated from protobuf message pb.LoginResponse
 */
...
/**
 * @generated MessageType for protobuf message pb.LoginResponse
 */
...
export const AuthApiService = new ServiceType("pb.AuthApiService", [
  {
    name: "Login",
    options: { "google.api.http": { post: "/api/v3/auth/login", body: "*" } },
    I: LoginRequest,
    O: LoginResponse,
  },
  {
    name: "Register",
    options: {
      "google.api.http": { post: "/api/v3/auth/register", body: "*" },
    },
    I: RegisterRequest,
    O: LoginResponse,
  },
