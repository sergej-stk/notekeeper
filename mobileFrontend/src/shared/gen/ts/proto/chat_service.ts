  ...
  constructor() {
    super("pb.ChatMessage", [
      { no: 1, name: "room_id", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
      {
        ...
        options: { "validate.rules": { string: { email: true } } },
      },
      {
        no: 3,
        name: "message",
        kind: "scalar",
        T: 9 /*ScalarType.STRING*/,
        options: { "validate.rules": { string: { minLen: "1" } } },
      },
    ]);
  }
    ...
    super("pb.StartChatRequest", [
      {
        ...
        options: {
          "validate.rules": {
            repeated: { items: { string: { email: true } } },
          },
        },
      },
    ]);
...
class StartChatResponse$Type extends MessageType<StartChatResponse> {
      ...
      switch (fieldNo) {
        ...
        case /* repeated pb.ChatMessage messages */ 2:
          message.messages.push(
            ChatMessage.internalBinaryRead(reader, reader.uint32(), options),
          );
          break;
        default:
          let u = options.readUnknownField;
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.messages.length; i++)
      ChatMessage.internalBinaryWrite(
        message.messages[i],
...
class SendChatMessageRequest$Type extends MessageType<SendChatMessageRequest> {
  ...
  create(
    value?: PartialMessage<SendChatMessageRequest>,
...
class GetAllChatMessagesRequest$Type extends MessageType<GetAllChatMessagesRequest> {
  ...
  create(
    value?: PartialMessage<GetAllChatMessagesRequest>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetAllChatMessagesRequest,
  ): GetAllChatMessagesRequest {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
...
class GetAllChatMessagesResponse$Type extends MessageType<GetAllChatMessagesResponse> {
  ...
  create(
    value?: PartialMessage<GetAllChatMessagesResponse>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetAllChatMessagesResponse,
  ): GetAllChatMessagesResponse {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
...
export const ChatApiService = new ServiceType("pb.ChatApiService", [
  {
    name: "StartChat",
    options: { "google.api.http": { post: "/api/v3/chat", body: "*" } },
    I: StartChatRequest,
    O: StartChatResponse,
  },
  {
    ...
    options: {
      "google.api.http": { post: "/api/v3/chat/{room_id}", body: "*" },
    },
  ...
  },
  {
    ...
    options: { "google.api.http": { get: "/api/v3/chat/{room_id}" } },
    I: GetAllChatMessagesRequest,
    O: GetAllChatMessagesResponse,
  },
]);
