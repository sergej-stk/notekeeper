...
class AnswerAddFriendRequest$Type extends MessageType<AnswerAddFriendRequest> {
  ...
  create(
    value?: PartialMessage<AnswerAddFriendRequest>,
...
class CheckFriendshipRequest$Type extends MessageType<CheckFriendshipRequest> {
  ...
  create(
    value?: PartialMessage<CheckFriendshipRequest>,
...
class CheckFriendshipResponse$Type extends MessageType<CheckFriendshipResponse> {
  ...
  create(
    value?: PartialMessage<CheckFriendshipResponse>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: CheckFriendshipResponse,
  ): CheckFriendshipResponse {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* repeated pb.Friend friends */ 1:
          message.friends.push(
            Friend.internalBinaryRead(reader, reader.uint32(), options),
          );
          break;
        default:
          let u = options.readUnknownField;
...
export const FriendApiService = new ServiceType("pb.FriendApiService", [
  {
    name: "GetFriends",
    options: { "google.api.http": { get: "/api/v3/friend" } },
    I: Empty,
    O: GetFriendListResponse,
  },
  {
    name: "AddFriend",
    options: { "google.api.http": { post: "/api/v3/friend", body: "*" } },
    I: AddFriendRequest,
    O: AddFriendResponse,
  },
  {
    name: "AnswerFirend",
    options: {
      "google.api.http": { post: "/api/v3/friend/answer", body: "*" },
    },
    I: AnswerAddFriendRequest,
    O: Empty,
  },
]);
