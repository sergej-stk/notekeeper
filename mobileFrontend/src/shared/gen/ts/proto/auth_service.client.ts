...
export interface IAuthApiServiceClient {
  ...
  register(
    ...
    options?: RpcOptions,
  ): UnaryCall<RegisterRequest, LoginResponse>;
}
/**
 * @generated from protobuf service pb.AuthApiService
 */
export class AuthApiServiceClient
  implements IAuthApiServiceClient, ServiceInfo
{
  ...
  register(
    ...
    const method = this.methods[1],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<RegisterRequest, LoginResponse>(
      "unary",
      this._transport,
      method,
      opt,
